module github.com/wethegamers/kubefirst
...
require (
	...
	github.com/kubefirst/metrics-client v0.3.1
	...
	github.com/wethegamers/kubefirst-api v0.129.0
...
replace github.com/wethegamers/kubefirst-api => ../kubefirst-api

replace github.com/wethegamers/metrics-client => ../metrics-client

replace github.com/wethegamers/cli-utils => ../cli-utils
